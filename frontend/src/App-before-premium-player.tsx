    ...
    lectures: [
      {
        ...
        duration: "23:39",
        videoUrl: "https://pub-edfa7b2fb8204f23bd7d5a9f86bc0ca0.r2.dev/cyber-security/Module%201%20%E2%80%94%20Introduction/lecture-1.mp4",
        questions: [
          {
          ...
          <section className="mt-8 rounded-3xl border border-white/10 bg-[#070907] p-6 sm:p-8">
            ...
            {!submitted ? (
              ...
              <div className={`mt-8 rounded-2xl border p-6 text-center ${passed ? "border-lime-400/30 bg-lime-400/5" : "border-red-400/20 bg-red-400/5"}`}>
                ...
                <p className={`mt-2 text-5xl font-black ${passed ? "text-lime-400" : "text-red-300"}`}>{score}/{lecture.questions.length}</p>
                <p className="mt-3 font-semibold">{passed ? "🎉 Passed — you can retake this quiz anytime." : "❌ Not passed — you can retry as many times as needed."}</p>
                <div className="mt-5 flex flex-col justify-center gap-3 sm:flex-row">
                  ...
                  <button
                    onClick={onBack}
                    className="rounded-xl border border-white/10 px-6 py-3 font-bold text-white hover:border-lime-400/30 hover:text-lime-300"
                  >
                    Back to Course
                  </button>
                </div>
